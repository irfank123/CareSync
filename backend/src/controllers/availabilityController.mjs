...
export const createTimeSlot = asyncHandler(async (req, res, next) => {
  ...
  // Check if the user has permission to create slots for this doctor
  const canCreateSlot = 
    req.userRole === 'admin' || 
    req.userRole === 'staff' || 
    (req.userRole === 'doctor' && req.body.doctorId === req.user._id.toString());
...
export const updateTimeSlot = asyncHandler(async (req, res, next) => {
  ...
  const canUpdateSlot = 
    req.userRole === 'admin' || 
    req.userRole === 'staff' || 
    (req.userRole === 'doctor' && slot.doctorId.toString() === req.user._id.toString());
...
export const generateTimeSlots = asyncHandler(async (req, res, next) => {
  ...
  // Check if the user has permission to generate slots for this doctor
  const canGenerateSlots = 
    req.userRole === 'admin' || 
    req.userRole === 'staff' || 
    (req.userRole === 'doctor' && doctorId === req.user._id.toString());
...
export const importFromGoogle = asyncHandler(async (req, res, next) => {
  ...
  // Check if the user has permission to import slots for this doctor
  const canImportSlots = 
    req.userRole === 'admin' || 
    req.userRole === 'staff' || 
    (req.userRole === 'doctor' && doctorId === req.user._id.toString());
...
export const exportToGoogle = asyncHandler(async (req, res, next) => {
  ...
  // Check if the user has permission to export slots for this doctor
  const canExportSlots = 
    req.userRole === 'admin' || 
    req.userRole === 'staff' || 
    (req.userRole === 'doctor' && doctorId === req.user._id.toString());
...
export const syncWithGoogle = asyncHandler(async (req, res, next) => {
  ...
  // Check if the user has permission to sync slots for this doctor
  const canSyncSlots = 
    req.userRole === 'admin' || 
    req.userRole === 'staff' || 
    (req.userRole === 'doctor' && doctorId === req.user._id.toString());
